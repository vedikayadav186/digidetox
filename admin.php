...
if ($result) {
    ...
    // Calculate the total sum of all e-waste items
    $totalCount = array_sum($eWasteTypes);
}
    // Start HTML output
    ?>
...
<div class="col-div-4">
    <div class="box-4">
        <div class="content-box">
            <p>Total E-Waste <a href="ecount.php" class="view-all"><span>View All</span></a></p>
            <div class="circle-wrap">
                <div class="circle">
                    ...
                    <div class="inside-circle"><?php echo $totalCount; ?></div>
                </div>
            </div>
        </div>
    </div>
