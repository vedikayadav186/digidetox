    ...
    <style>
        ...
        * {
        ...
        .information .Flow {
            ...
            /* Take up half of the available space */
            max-width: 50%;
            /* Limit the width to half of the container */
            height: auto;
        ...
        #about {
            ...
            padding: 20px;
            font-family: 'Times New Roman', Times, serif;
            /* Correct the font-family property */
        }
        ...
        .animated-sentence {
            ...
            text-align: center;
            margin-bottom: 20px;
            animation: animateSentence 2s ease-in-out 1 forwards;
            /* Animation runs once and stops at final position */
        }
